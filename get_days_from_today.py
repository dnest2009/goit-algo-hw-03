...
def get_days_from_today(when_this_day:str):  #вхідні дані - дата у форматі:"string"
    try:                                #на випадок отримання даних у не правильному форматі
        today = datetime.today()     #поточна дата у форматі datetime
        ...
        now_date = datetime.strptime(when_this_day,"%Y-%m-%d")  #перетворення вхідної дати у об'єкт datatime
        delta_days = (now_date - t).days   #різниця між вхідною і поточною датами у ДНЯХ
